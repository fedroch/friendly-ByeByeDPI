...
```
  shell pm grant io.github.fedroch.byedpi android.permission.WRITE_SECURE_SETTINGS
  shell appops set io.github.fedroch.byedpi WRITE_SETTINGS allow
  shell appops set io.github.fedroch.byedpi ACTIVATE_VPN allow
```
...
```
  pm grant io.github.fedroch.byedpi android.permission.WRITE_SECURE_SETTINGS
  appops set io.github.fedroch.byedpi WRITE_SETTINGS allow
  appops set io.github.fedroch.byedpi ACTIVATE_VPN allow
```
