...
android {
    namespace = "io.github.fedroch.byedpi"
    compileSdk = 36
    signingConfigs {
        create("release") {
            // Укажите здесь путь к вашему файлу ключа и пароли
            // Если файла ключа пока нет, можно временно использовать дебажный:
    ...
    defaultConfig {
        applicationId = "io.github.fedroch.byedpi"
        minSdk = 21
